...
loglog(sphere_nodes,sphere_error,'-v','Color','#7E2F8E')
hold on


loglog(linspace(1,maxnodes,maxnodes),order_sphere,'--','Color','#ff1493')
hold on
...
legend({'eq-weight','linesearch','PMP','FC-PMP','gcos','FC-gcos','FC','SBQ','Spherical','(1/n)^{3/4}'},'FontSize',14,'NumColumns',2)
set(gca,'FontSize',16); 
